                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="<?= base_url() ?>assets/backend/src/images/image-1.gif"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <span><strong>Password Anda Telah Di
                                                                        ubah<br /><br /><br /></strong></span>
                                                            </h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Hallo
                                                                    <?php echo $user->name ?>,</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Email ini untuk
                                                                    mengonfirmasi bahwa anda telah melakukan perubahan
                                                                    pada password akun anda</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Jika anda merasa tidak
                                                                    melakukan perubahan pada password anda, maka
                                                                    silahkan hubungi kami untuk melaporkan di menu call
                                                                    center</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Berikut informasi login
                                                                    baru anda :</p>
                                                                <p style="line-height: 140%;">Login id :
                                                                    <strong><?php echo $user->username ?></strong> or
                                                                    <strong><?php echo $user->email ?></strong>
                                                                </p>
                                                                <p style="line-height: 140%;">New password :
                                                                    <strong><?php echo $new_password ?></strong>
                                                                </p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Thank you for using our
                                                                    service.😃</p>
                                                                <p style="line-height: 140%;"> </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align" align="center">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com/templates" style="height:37px; v-text-anchor:middle; width:147px;" arcsize="11%"  stroke="f" fillcolor="#316b94"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                                                <a href="<?php echo $link_login ?>"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:10px 20px;line-height:120%;">Go
                                                                        to login page</span>
                                                                </a>
