<!-- add category modal -->
<div class="modal fade" id="add-variations-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    style="display: none; padding-right: 17px;" aria-modal="true">
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" action="<?= base_url('admin/addProductVariations') ?>" method="post"
            id="add-variations">
